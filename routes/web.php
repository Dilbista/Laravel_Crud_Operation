...
Route::group(['middleware' => 'auth'], function () {
  ...
  //product list
  Route::get('products', [ProductController::class, 'index'])->name('productlist.index');
  Route::get('products/create', [ProductController::class, 'create'])->name('productlist.create');
